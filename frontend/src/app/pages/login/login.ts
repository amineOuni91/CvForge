...
@Component({
  ...
  template: `
    <main class="flex min-h-screen items-center justify-center bg-slate-100">
      ...
      >
        <h1 class="mb-4 text-xl font-bold text-slate-800">{{ 'auth.login.title' | t }}</h1>
        ...
        <div class="mt-4 flex justify-between text-sm">
          <a routerLink="/forgot-password" class="text-slate-600 hover:underline">{{
            'auth.login.forgot' | t
          }}</a>
          <a routerLink="/register" class="text-slate-600 hover:underline">{{
